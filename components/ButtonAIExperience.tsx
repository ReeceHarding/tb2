...
const ButtonAIExperience = ({ extraStyle }: { extraStyle?: string }) => {
  const router = useRouter();

  const handleClick = () => {
    console.log("[ButtonAIExperience] Button clicked - navigating to /auth");
    router.push("/auth");
  };
  ...
  return (
    ...
    >
      <span className="inline-flex items-center gap-2">
        <span>Try our interactive AI experience</span>
        <svg
...
export default ButtonAIExperience;