      ...
      >
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full overflow-hidden items-start md:items-center justify-center p-2">
            ...
            >
              <Dialog.Panel className="relative w-full max-w-3xl h-full overflow-visible transform text-left align-middle shadow-2xl transition-all rounded-xl bg-white border border-timeback-primary p-6 md:p-8 font-cal">
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <Transition.Child
              ...
              leaveTo="opacity-0 scale-95"
            >
              <Dialog.Panel className="relative w-full max-w-4xl max-h-[90vh] overflow-hidden transform text-left align-middle shadow-2xl transition-all rounded-xl bg-white border border-timeback-primary font-cal">
