                  ...
                  {expandedStudy === 'blooms' && (
                    <div className="mt-4 pt-4 border-t border-timeback-primary border-opacity-30">
                      ...
                      <p className="text-timeback-primary mb-3 font-cal">
                          ...
                          This is why our students consistently learn 2x the material in just 2 hours a day (≈6x faster learning rate) and reach the 98th percentile.
                      </p>
                      <a 
                  ...
                  {expandedStudy === 'adaptive' && (
                    <div className="mt-4 pt-4 border-t border-timeback-primary border-opacity-30">
                      ...
                      <p className="text-timeback-primary mb-3 font-cal">
                        ...
                        and providing targeted support. This creates the individualized learning plan that research proves drives ~6x faster learning while enabling 2x the material in just 2 hours a day.
                      </p>
                      <a 
