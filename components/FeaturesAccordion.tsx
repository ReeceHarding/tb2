...
const FeaturesAccordion = () => {
  ...
  return (
    ...
    >
      <div className="px-8">
        <h2 className="font-extrabold text-4xl lg:text-5xl tracking-tight mb-12 md:mb-24 font-cal">
          All you need to ship your startup fast
          <span className="bg-neutral text-neutral-content px-2 md:px-4 ml-1 md:ml-1.5 leading-relaxed whitespace-nowrap font-cal">
            and get profitable
          </span>
        </h2>
        <div className=" flex flex-col md:flex-row gap-12 md:gap-24">
          <div className="grid grid-cols-1 items-stretch gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-12">
            <ul className="w-full">
